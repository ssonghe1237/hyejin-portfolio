 ...
 * fileName       : AdminResearchCreateRequestDto
 * author         : Song
 * date           : 2026-08-03
 * description    : 관리자 Research 게시글 등록 요청 DTO
 *                  - Research 제목, slug, 요약 및 본문 HTML 등록
 *                  - 카테고리, 노출 순서 및 공개 여부 등록
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
 * 2026-08-03        Song       최초 생성
 */
public record AdminResearchCreateRequestDto(
