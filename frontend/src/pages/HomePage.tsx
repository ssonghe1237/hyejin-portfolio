...
function HomePage() {
  ...
  return <div className={styles.page}>
    ...
    <section id="contact" className={styles.contact} aria-labelledby="contact-title"><div className={styles.contactTop}><div><p className={styles.kicker}>06 · CONTACT</p><h2 id="contact-title">똑똑,<br />지금도 여기 있습니다!</h2></div><a href={`mailto:${email}`}>{email}</a></div><div className={styles.contactGrid}><article><small>EMAIL</small><p>편하게 메일 주세요.<br />협업과 새로운 기회에 열려 있습니다.</p><a href={`mailto:${email}`}>메일 보내기 →</a></article><article><small>GITHUB</small><p>더 자세한 개발과 프로젝트를<br />확인해 보세요.</p>{contact?.githubUrl && <a href={contact.githubUrl} target="_blank" rel="noopener noreferrer">GitHub 살펴보기 →</a>}</article></div></section>
  </div>
}
